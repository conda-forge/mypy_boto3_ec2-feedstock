About mypy_boto3_ec2-feedstock
==============================
...
Summary: Type annotations for boto3.EC2 1.43.100 service, generated by mypy-boto3-builder
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/mypy_boto3_ec2-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mypy_boto3_ec2-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add mypy_boto3_ec2
# for installing globally
pixi global install mypy_boto3_ec2
```
...
It is possible to list all of the versions of `mypy_boto3_ec2` available on your platform:
...
```
pixi search mypy_boto3_ec2 --channel conda-forge
```
